...
print(money)
```
The number of students to make the payoff fair is 28.
...
print (money)
```
Overall Mr.Brownlow will consume and make up to 313 in total.
...
In conclusion, Mr.Brownlow has to change the number of students and change how much money(payout)
he pays against the dollar.